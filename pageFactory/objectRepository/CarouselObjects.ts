export class CarouselObjects {
    ...
    protected static PRODUCT_ITEM_VISIBLE = `product div.build-accessories-product-container >> visible=true`;
    protected static PRODUCT_ITEMS = `product div.build-accessories-product-container`;
